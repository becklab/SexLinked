  #setwd("/Volumes//Beck Lab/TCGA_January_2014/")
# setwd("~/Dropbox/Sex_Linked_Cancer_Research/Analysis")
...
##rownames of clinical data are barcodes. To access rows of clinical data, need a vector of barcodes
...
# we only want to do computations on normals and tumors for which we have clinical data (i.e. gender, age, etc.)
...
#Plotting age, colored by tissue type
...
setwd("~/Dropbox/ExpressionSexProject")
...
# pdf("ManhattanPlot_GenderPs_TumorsAndNormals.pdf")
par(mfrow=c(2,1))
